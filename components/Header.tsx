  ...
  return (
    <header className="bg-stone-50/80 backdrop-blur-sm sticky top-0 z-50 shadow-sm border-b border-stone-200">
        <div className="container mx-auto px-6 py-2 flex justify-between items-center">
             <a href="#chamado" onClick={(e) => handleNavClick(e, '#chamado')} className="flex items-center space-x-3" title="Coalizão pelo Vale do Jequitinhonha">
                <img src="https://i.ibb.co/NnQ0Vjjr/avatar-climax-jequitinhonha.png" alt="Coalizão Logo" className="h-12 w-12 rounded-full" />
                <span className="text-xl font-black text-stone-800 hidden sm:block">COALIZÃO</span>
            </a>
